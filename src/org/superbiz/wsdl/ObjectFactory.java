 ...
 * generated in the org.superbiz.wsdl package. 
...
public class ObjectFactory {
    ...
    private final static QName _MultiplyResponse_QNAME = new QName("http://superbiz.org/wsdl", "multiplyResponse");
    private final static QName _SumResponse_QNAME = new QName("http://superbiz.org/wsdl", "sumResponse");
    private final static QName _Sum_QNAME = new QName("http://superbiz.org/wsdl", "sum");
    private final static QName _Multiply_QNAME = new QName("http://superbiz.org/wsdl", "multiply");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: org.superbiz.wsdl
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://superbiz.org/wsdl", name = "multiplyResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://superbiz.org/wsdl", name = "sumResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://superbiz.org/wsdl", name = "sum")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://superbiz.org/wsdl", name = "multiply")
